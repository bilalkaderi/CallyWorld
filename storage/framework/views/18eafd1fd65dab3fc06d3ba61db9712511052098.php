...
function delivered(id){
  ...
  $.ajax({
    url:"<?php echo e(route('delivered')); ?>",
      method:'POST',
      data: {id:id},
      success: function(output){
          // $("#user_"+id).fadeOut();
          ...
          <table class="table table-sm">
            ...
            <tbody>
              <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr id="order_<?php echo e($o->id); ?>" class="<?php echo e($o->status); ?>">
                  <th scope="row"><?php echo e($o->id); ?></th>
                <th scope="row"><?php echo e($o->cartId); ?></th>
                ...
                <td>
                  <?php if($o->status=='pending'): ?>
                    ...
                    ?>
                    <strong><?php if($dt<$now): ?> <span style="font-size:20px;color:red">!!!</span> <?php endif; ?> Expected Date:</strong> <?php echo e($dt); ?>
                  ...
                  <?php elseif($o->status=='confirmed'): ?>
                    ...
                    ?>
                    <?php echo e($o->expecting_delivery_date); ?>, <strong><?php if($d1>$d2): ?> from <?php else: ?> in <?php endif; ?><?php echo e($days); ?> Days</strong>
                  <?php endif; ?>
                </td>
                <td>
                  <?php if($o->status=='Packed'): ?>
                    <button type="button" class="btn btn-success" onclick="delivered(<?php echo e($o->id); ?>)">Delivered</button>
                  <?php elseif($o->status=='confirmed'): ?>
                    <button type="button" class="btn btn-primary" onclick="alertByMail(<?php echo e($o->id); ?>)">Alert by Mail</button>
                  ...
                  <?php endif; ?>
                  <!-- <div class="dropdown">
                    <button class="btn btn-primary dropdown-toggle" value="<?php echo e($o->id); ?>" type="button" id="dropdownMenu_<?php echo e($o->id); ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      Adjust Status
                    </button>
                    <div class="dropdown-menu" id="dropdown-menu_<?php echo e($o->id); ?>" aria-labelledby="dropdownMenu<?php echo e($o->id); ?>">
                      <button class="dropdown-item" type="button" id="change1" onclick="changeStatus(<?php echo e($o->id); ?>)" value="On Preparing">On Preparing</button>
                      <button class="dropdown-item" type="button" id="change2" onclick="changeStatuss(<?php echo e($o->id); ?>)" value="On Delivery">On Delivery</button>
                      <button class="dropdown-item" type="button" id="change3" onclick="changeStatusss(<?php echo e($o->id); ?>)" value="Delivered">Delivered</button>
                    </div>
                    <button class="btn btn-light" type="button" onclick="returnProducts(<?php echo e($o->id); ?>)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      Check Products
                    </button>
                  </div>
                </td> -->
...
<?php /**PATH C:\xampp\htdocs\CallyWorld\resources\views/admin/orders.blade.php ENDPATH**/ ?>