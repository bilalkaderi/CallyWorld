        ...
        <div class="d-flex align-items-center mt-2">
            <div class="ms-auto number">
              ...
              <div class="">
                ...
                <strong><?php echo e($newprice); ?></strong>
              </div>
              <div class="" style="font-style:italic">
                <center><?php echo e($description); ?></center>
              </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\CallyWorld\resources\views/layouts/email-newProduct.blade.php ENDPATH**/ ?>