      ...
      <div class="text-uppercase">Hello <?php echo e($to); ?></div>
        <div class="d-flex align-items-center mt-2">
            ...
            <div class="ms-auto number">
              You have to verify your email by visiting this link below:
            <a href="http://127.0.0.1:8000/verifiy/<?php echo e($token); ?>">Please visit this link..</a>
          </div>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\CallyWorld\resources\views/layouts/email-template.blade.php ENDPATH**/ ?>