  ...
  if($("#quantity_"+id).val()>1){
    ...
    function orderCart(){
      ...
      if(address==''){
        ...
        $.ajax({
            url:"<?php echo e(route('orderCart')); ?>",
            method:'post',
             ...
             <div class="row">
                 <div class="col-lg-9 my-lg-0 my-1">
                   <div class="d-flex flex-column">
                     <div class="h5">Hello <?php echo e($client->name); ?></div>
                     <div>Logged in as: <?php echo e($client->email); ?></div>
                   </div>
                   <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     ...
                     ?>
                       <div class="order my-3 bg-light" style="padding:20px;border-radius:10px;" id="cart_<?php echo e($c->id); ?>">
                           <div class="row" >
                               <div class="col-lg-4">
                                   <div class="d-flex flex-column justify-content-between order-summary">
                                       <div class="d-flex align-items-center">
                                         <div class="text-uppercase">Cart #<?php echo e($c->id); ?></div>
                                       </div>
                                       <div class="d-flex align-items-center">
                                         <div class="text-uppercase">Address: <?php echo e($c->pref_address); ?></div>
                                       </div>
                                       <div class="fs-8"><?php echo e($c->created_at); ?></div>
                                   </div>
                               </div>
                               <div class="col-lg-8" >
                                   <div class="d-sm-flex align-items-sm-start justify-content-sm-between">
                                     <div class="status">Status : <?php echo e($c->status); ?></div>
                                       <?php if($c->status=='On Preparing'): ?>
                                         <?php
                                         ...
                                         <div class="red-label ms-auto text-uppercase">
                                          <?php if($d1>$d2): ?> <?php echo e($c->expecting_delivery_date); ?> Too Late <?php else: ?> <?php if($c->status=='On Preparing'): ?>Ready In <?php else: ?> In <?php endif; ?> <?php echo e($days); ?> Days <?php endif; ?></div>
                                         <?php elseif($c->status=='On Delivery'): ?>
                                          <div class="blue-label ms-auto text-uppercase">Exp. Del. Time <?php echo e($c->delivery_hour); ?></div>
                                         <?php elseif($c->status=='Delivered'): ?>
                                          <div class="blue-label ms-auto text-uppercase">Delivered on <?php echo e($c->updated_at); ?></div>
                                        <?php else: ?>
                                         <div class="blue-label ms-auto text-uppercase">Exp. Del. Date <?php echo e($c->expecting_delivery_date); ?></div>
                                        <?php endif; ?>

                                   </div>
                                   <div class="progressbar-track">
                                     <?php if($c->status=='Delivered'): ?>
                                        <span class="fas fa-gift" style="color:green;font-size:25px"></span>
                                       <div id="tracker"></div>
                                     <?php elseif($c->status=='On Delivery'): ?>
                                       <span class="fas fa-box" style="color:blue;font-size:25px"></span>
                                       <div id="tracker"></div>
                                       <?php elseif($c->status=='On Preparing'): ?>
                                   ...
                                   <div class="d-sm-flex align-items-sm-start justify-content-sm-between">
                                     <div class="status"><strong>Products :</strong><br>
                                       ...
                                       <?php $__currentLoopData = $prod; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($p->name); ?>: <?php echo e($quantity); ?> items
                                       <div class="" style="font-size:14px">
                                         Item's price: $ <?php echo e($data['price']); ?>
                                     ...
                                     <div class="red-label ms-auto text-uppercase"><strong>Total: </strong>$<?php echo e($c->total_amount); ?></div>
                                   </div>
                                   <?php if($c->delivery_details >0): ?>
                                   <?php
                                    $delman=DB::table('deliveryman')->where('id','=',$c->delivery_details)->first();
                                   ?>
                                   <div class="red-label ms-auto text-uppercase"><strong>Driver: </strong><?php echo e($delman->name); ?><p><a style="color:white" href='tel:<?php echo e($delman->phone); ?>'><?php echo e($delman->phone); ?></a></p></div>
                                   <?php endif; ?>
                               </div>
                               <div class="alert alert-success" id="alertConfirm_<?php echo e($c->id); ?>" style="display:none;margin-top:15px"></div>
                             </div>
                           </div>
                       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                   </div>
      ...
      <div class="col-md-8">
        <div class="card mb-4">
          <div class="card-header py-3">
            <h5 class="mb-0">Cart - <input readonly type="number" id="countItems" style="font-weight:500;font-size:30;border:0;width:40px" value="<?php echo e($count); ?>"> items</h5>
          </div>
          <div class="card-body">
            <!-- Single item -->
            ...
            <div class="row" id="item_<?php echo e($prod->id); ?>">
              <div class="col-lg-3 col-md-12 mb-4 mb-lg-0">
                <!-- Image -->
                 <?php
                   $pr=$item['price'];
                 ?>
                <input type="number" id="product_price_<?php echo e($prod->id); ?>" value="<?php echo e($pr); ?>" readonly style="display:none">
                <div class="bg-image hover-overlay hover-zoom ripple rounded" data-mdb-ripple-color="light">
                  <img src="<?php echo e(asset ('img/'.$prod->photo)); ?>"
              ...
              <div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
                <input type="number" style="display:none" readonly id="time_<?php echo e($prod->id); ?>" value="<?php echo e($prod->expecting_delivery_time); ?>">
                <!-- Data -->
                <p><strong><?php echo e($prod->name); ?></strong></p>
                <p><?php echo e($prod->description); ?></p>
                <p>Size: <?php echo e($prod->width); ?> x <?php echo e($prod->height); ?></p>
                <?php
                  $time=$item['quantity']*$prod->expecting_delivery_time;
                ?>
                <p>Expecting Delivery Time: <?php if($val=$time%7 == 0): ?>
                                              <input type="number" style="width:30px;border:0;text-align: right;" readonly id="expecting_delivery_time_<?php echo e($prod->id); ?>" value="<?php echo e($val); ?>"> Week
                                            <?php else: ?>
                                               <input type="number" style="width:30px;border:0;text-align: right;" readonly id="expecting_delivery_time_<?php echo e($prod->id); ?>" value="<?php echo e($time); ?>">Days
                                            <?php endif; ?>
                </p>
                <button type="button" onclick="removeFromCart(<?php echo e($prod->id); ?>)" class="btn btn-danger btn-sm me-1 mb-2" data-mdb-toggle="tooltip"
                  title="Remove item">
              ...
              <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                ...
                <div class="d-flex mb-4" style="max-width: 300px">
                  <button class="btn btn-light px-3 me-2" id=""
                    onclick="decrease(<?php echo e($prod->id); ?>)">
                    <i class="fas fa-minus"></i>
                  </button>

                  <div class="form-outline">
                    <input id="quantity_<?php echo e($prod->id); ?>" readonly min="1" max="5"  name="quantity" value="<?php echo e($item['quantity']); ?>" type="number" class="form-control" />
                    <label class="form-label" for="form1">Quantity</label>
                  </div>

                  <button class="btn btn-light px-3 ms-2"
                    onclick="increase(<?php echo e($prod->id); ?>)">
                ...
                <p class="text-start text-md-center">
                   ...
                   ?>
                  <span><strong>$</strong><input type="number" readonly id="total_price_item_<?php echo e($prod->id); ?>" style="font-weight:800;border:0;width:45px" value="<?php echo e($total_price); ?>"></span>
                </p>
                <!-- Price -->
              </div>
            </div>
        ...
        <?php if($count!='0'): ?>
          <div class="card mb-4">
            <div class="card-body">
              ...
              ?>
              <p><strong>Expected Delivery Date</strong></p><input type="date" id="date" value="<?php echo e($max_day); ?>" style="display:none">
              <p class="mb-0"><?php echo e($dt); ?></p>
            </div>
          </div>
        <?php endif; ?>
          ...
          <div class="card-body">
            <ul class="list-group list-group-flush">
              ...
              <li
                ...
                <span><strong>$<?php $total=$totalPrice+$delivery ?></strong><input type="number" readonly id="totalPrice" style="font-weight:800;border:0;width:45px" value="<?php echo e($total); ?>"></strong></span>
              </li>
            </ul>
          <?php if($count!='0'): ?>
          ...
          <div class="modal-dialog" role="document" style="height:auto">
            <div class="modal-content" style="width:auto;height:auto">
              ...
              <div class="modal-body">
                      ...
                      <div class="card-form">
                        ...
                        <form action="<?php echo e(route('processPayment')); ?>" method="POST">
                          ...
                          <div class="form-row">
                            ...
                            <input type="text" style="display:none" value="<?php echo e($total); ?>" id="amountPayment" name="amountPayment">
                          </div>
                          <strong>Delivery Address:</strong>
                          <input type="text" name="addressClient" value="<?php echo e($client->address); ?>" id="addressClient" placeholder="Preferred Delivery Address" class="form-control">
                          <input type="date" id="date_2" value="<?php echo e($max_day); ?>" style="display:none">
                ...
                <div id="addressDiv">
                  <strong>Delivery Address:</strong>
                  <input type="text" name="address" value="<?php echo e($client->address); ?>" id="address" placeholder="Preferred Delivery Address" class="form-control">
                </div>
              </div>
              <div class="modal-footer">
...
<?php /**PATH C:\xampp\htdocs\CallyWorld\resources\views/cart.blade.php ENDPATH**/ ?>