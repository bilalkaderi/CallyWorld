    ...
    $(document).ready(function(){
      $("#dellogin").click(function(e){
        ...
        if($("#username").val().trim() == "" || $("#password").val().trim() == "")
          ...
          $.ajax({
              url:"<?php echo e(route('deliveryLogin')); ?>",
              method:'POST',
    ...
    <center>
          ...
          <h2 class="text-center" style="color:#bba174;font-family:Tangerine_Regular;font-size:100px">Cally Home</h2>
            <div class="alert alert-danger" id="clientalert" style="width:30%;display:none">
              <?php if(session()->has('deliveryman')): ?>
              <?php echo e(session()->get('deliveryman')); ?>
...
<?php /**PATH C:\xampp\htdocs\CallyWorld\resources\views/delivery/login.blade.php ENDPATH**/ ?>