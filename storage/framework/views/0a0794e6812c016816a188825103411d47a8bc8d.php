...
<?php if($subscribers): ?>
  <?php $__currentLoopData = $subscribers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if(session()->has('clientemail')): ?>
...
<script type="text/javascript">
    $(document).ready(function(){
      ...
      $("#unsubscribe").click(function(){
          ...
          $.ajax({
              url:"<?php echo e(route('unsubscribe')); ?>",
              method:'post',
              data:form_data,
              contentType: false, //multipart/form-data
              processData: false,
    ...
    function report(id){
      ...
      form_data.append("reportmessage", reportmessage);
        ...
        function block(id){
          ...
          form_data.append("clientid", clientid);
            $.ajax({
                url:"<?php echo e(route('blockUser')); ?>",
                method:'post',
                data: form_data,
                contentType: false, //multipart/form-data
                processData: false,
          ...
          <div class='box' style="">
              <div class='front' style='border-radius:50px'>
                <?php if($p->photo !=null && file_exists(public_path()."/img/$p->photo")): ?>
                  <img src="<?php echo e(asset('img/'.$p->photo)); ?>" style='width:300px;height:240px;border-radius:20px' alt='' id="">
                <?php else: ?>
              ...
              <div class='back'>
                ...
                <p><strong><?php echo e($p->price); ?>$</strong></p>
              </div>
            </div>
          </td>
...
<header id="header" style="position: fixed;width:100%;z-index: 1000;top:0;">
       ...
       <div class="container" >
           ...
           <div class="collapse navbar-collapse" id="mynav">
               <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                   <li class="nav-item">
                       <a class="nav-link active" aria-current="page" href="<?php echo e(route('home')); ?>">Homepage
                            ...
                            <td style="text-align:center">
                             <div class="form-group">
                               ...
                               <div class="reason-report" style="display:none">
                                 ...
                                 <button type="button" onclick="report(<?php echo e($user->id); ?>)" class="btn btn-danger" id="last-report" style="background-color:#dc3545;color:#fff;cursor:pointer">Report</button>
                               </div>
                               <div class="block" style="display:none">
                                 <h4>Do you want to block this supplier? You will be returned to homepage.</h4>
                                 <button type="button" onclick="block(<?php echo e($user->id); ?>)" class="btn btn-info" style="background-color:#17a2b8;color:#fff;cursor:pointer">Block</button>
                   ...
                   <li class="nav-item" style="float:right">
                     <form class="" action="" method="post">
                       <?php echo csrf_field(); ?>
                       <center>
                       <a class="nav-link"><div class="ratingDiv" style="margin-top:">Rate <?php echo e($user->name); ?>:
                           <div class="rating">
        ...
        <div class="" style="float:center;margin-top:130px">
          <div class="" style="width:650px;padding:0  30px 30px 30px; background-color:#fff; border-radius:10px; ">
            <div class="" style="background-color:;border-radius:5px;padding:20px;">
              <button id="userid" style="display:none" value="<?php echo e($user->id); ?>" disabled></button>
              <div class="" style="width:500px; margin-top:-15px">
                <div class="" style="background-color:#444;height:130px;border-radius:10px;">
                  <img src="<?php echo e(asset('profiles/'.$user->photo)); ?>" alt="" style="margin-top: 30px;width:250px;height:230px;border-radius:130px;box-shadow: 0 5px 3px rgba(0,0,0, 0.2 ), 0 -5px 5px rgba(0,0,0, 0.200);">
                </div>
              </div>
              <div class="" style="margin-top:200px; ">
                ...
                <div class="" style="background-color:rgb(240,240,240); padding: 40px; width:400px; border-radius: 5px;">
                  <center><p style="color:black;font-weight: 600;font-size:18px"><?php echo e($user->aboutme); ?></p></center>
                </div>
              </div>
            </div>
            <div class="" style=" width: 450px;display: flex;">
              <div class="" style="flex:1;">
                <h5>Followers</h5>
                <p><?php echo e($followers); ?></p>
              </div>
              <div class="" style="flex: 1;">
                <h5>Products</h5>
                <p><?php echo e($nbPro); ?></p>
              </div>
              <div class="" style="flex: 1;">
                <h5>Rating</h5>
                <p><?php echo e($ratings); ?></p>
              </div>
            </div>
    ...
    <div class="" style="border-radius:10px;padding:0 350px;margin:6px;float:center; display: flex;align-items: center;overflow-x: auto; scroll-behavior: auto;;" >
        <?php $__currentLoopData = $userproducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php
  ...
  <section class="ftco-section" style="padding:50px 0 50px 0;">
    <div class="contact-form" style="width:100%" >
      <center>
          <div class="container" style="background-image: url(<?php echo e(asset('css/back.jpg')); ?>);background-size:cover;width:90%;padding:">
                    ...
                    <div class="col-md-9 col-lg-7">
                      <div class="contact-wrap w-100 p-md-5 p-4">
                        ...
                        <form action="" method="post">
                          <?php echo csrf_field(); ?>
                          <div class="row">
                            <input type="email" name="to" id="to" placeholder="Recipient's Email" value="<?php echo e($user->email); ?>" style="display:none">
                            <div class="col-md-6">
                              <div class="form-group">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                <button type="button" value="Send Message" onclick="sendEmail(<?php echo e($user->id); ?>)" class="btn btn-secondary">Send Message</button>
...
<?php /**PATH C:\xampp\htdocs\CallyWorld\resources\views/userprofile.blade.php ENDPATH**/ ?>