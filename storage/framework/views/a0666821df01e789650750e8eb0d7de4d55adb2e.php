          ...
          <div class=''>
            ...
            <span>
                  ...
                  <center>
                    ...
                    <tr>
                      ...
                      <td style="text-align:right" colspan="3" rowspan="5">
                        <label for='photo'><img src="<?php echo e(asset('profiles/'.$u->photo)); ?>" class='photo' name='photo' title='Choose photo' style="border-radius:100px;height:300px;width:300px" id='profilephoto'/></label><br>
                    ...
                    <tr>
                      <td><input id='updatename' class='updatetext' type='text' value='<?php echo e($u->name); ?>' name='clientname' /></td>
                      <td><input id='updatephone' class='updatetext' type='text' value='<?php echo e($u->phone); ?>' name='clientphone' /></td>
                    </tr>
                    <tr>
                      <td colspan="2"><input id='updateaboutme' class='updatetext' type='text' value='<?php echo e($u->aboutme); ?>' style="height:200px;width:90%" placeholder="Add some info about yourself!" name='clientphone' /></td>
                    </tr>
                  </table>
                  </center>
                  <center><button type='button' onclick='updateUser(<?php echo e($u->id); ?>)' id='buttonupdate' class='buttonupdate'>Save &#10004;</button></center></span>
                </div>
                <div class='info'><p>Do you want to change your password?</p>
                  ...
                  <button type='button' id='changepassword' style="color:white" class='btn btnchange' onclick="changepassword(<?php echo e($u->id); ?>)">Change Password</button>
                </div>
         ...
         <nav class="nav" id="navbar" style="background-color:rgba(0,0,0,0.05)">
           <div class="logo">
             <button style="border:0;background:transparent;border-radius:5px;font-size:40px" id="logo"><h1 class="logoh1">
               <img src="<?php echo e(asset('css/icons/pen.png')); ?>" style="width:44px;height:46px">CallyWorld</h1>
           </button>
         </div>
           <ul class="nav_list" id="navlinkitems" style="margin-top:-110px">
             <li class="nav_item">
               <a href="<?php echo e(route('home')); ?>" class="nav_link" id="home">Homepage</a>
             </li>
             <li class="nav_item">
             ...
             <?php if($u->role == 1): ?>
                 <li class="nav_item">
                   <a href="<?php echo e(route('admin')); ?>" class="nav_link" id="" style="background-color:rgba(6,40,120,0.2);border-radius:6px">Administrator Dashboard</a>
                 </li>
            <?php endif; ?>
            </ul>
         </nav>
                  ...
                  <?php $__currentLoopData = $userprod; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $up): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if($up->soldno > '0'): ?>
                        <div class='month-group'>
                         <div class='bar' style='height:<?php echo e($up->soldno); ?>0%' title='<?php echo e($up->soldno); ?>'></div>
              ...
              <table id="productstable"><tr>
                <?php $__currentLoopData = $userprod; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <td id='box_<?php echo e($p->id); ?>'><div class='box' id='box' style='display:relative'>
                    ...
                    <button type="button" onclick="deleteProduct(<?php echo e($p->id); ?>)" id="deleteProduct_<?php echo e($p->id); ?>" style='font-weight:800;position:absolute;margin-top:-35px;padding:3px 5px;font-size:24px' class='cancel' name='remove'>&times</button>
                    <div class='back'>
                      <h1 style='font-family:Calibri;color:#618685'><?php echo e($p->name); ?></h1>
                      <h5 style='font-family:Calibri;color:#618685;font-family:bold;font-size:20px'><?php echo e($p->description); ?></h5>
                      <p style='font-family:Calibri;color:#618685;font-size:20px'><?php echo e($p->price); ?> $
                      <button type="button" onclick="returnProduct(<?php echo e($p->id); ?>)" style='margin-left:5px;padding:10px;border:0;background-color:transparent'><img src='img/edit.png' style='border-radius:6px;background-color:lightblue;height:30px;width:33px;opacity:0.5;cursor:pointer;float:right'></button></p>
                      <?php if($commentsNb>0): ?>
                        <a href='/Comments/<?php echo e($p->id); ?>' class="atop" style=''>View comments</a>
                      <?php endif; ?>
                      </div>
                    </div></td>
          ...
          <center><span style="background-color:rgb(5,0,0);opacity: 0.8;border-radius:10px;justify-content: center;padding: 20px;width:100%;font-size:22px;font-family:Calibri;text-transform:uppercase;color:#fff">Orders from the last 7 days:</span></center>
           ...
           <table class='tab'  align=center>
                 <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr><td class='tab-td'> <img src="<?php echo e(asset('img/'.$o->photo)); ?>" alt='' class='image' id='img'>  </td>
                      <td>Ordered by <?php echo e($o->cname); ?></td>
                      <td><p style='justify-content:center'><?php echo e($o->name); ?><br><?php echo e($o->quantity); ?> item <?php if($o->quantity > 1): ?>s, each for $<?php echo e($o->price); ?><br>Total: $<?php echo e($o->total_price); ?> <?php else: ?> for $<?php echo e($o->price); ?><?php endif; ?></p></td>
                      <td id="" align=right style=''>
                        <p style="color:<?php if($o->status == 'confirmed'): ?>
                                      green
                                    <?php elseif($o->status == 'Sorry but the product you ordered is not available now.'): ?>
                                      red
                                    <?php endif; ?>" readonly id="status_<?php echo e($o->id); ?>">

                              <?php if($o->status == 'Sorry but the product you ordered is not available now.'): ?>Unavailable
                              <?php elseif($o->status=='confirmed'): ?> <?php echo e($o->status); ?>

                              <?php endif; ?>
                          </p>
                       <?php if($o->status == 'pending'): ?>
                       <button type="button" style="border:0" name='confirmorder' id="confirmorder_<?php echo e($o->id); ?>" onclick="confirmOrder(<?php echo e($o->id); ?>)" class='conf'>Confirm</button>
                         <button type="button" style="border:0" id="unavailable_<?php echo e($o->id); ?>" name='unavailable' onclick="cancelOrder(<?php echo e($o->id); ?>)" class='cancel'>Unavailable</button></td>
                      <?php endif; ?>
                      <td style="padding-left:50px"> <a href="https://api.whatsapp.com/send?phone=254777225366"><img src="<?php echo e(asset('css/icons/wa-logo.png')); ?>" style="width:34px;height:36px"></a></td>
...
<?php /**PATH C:\xampp\htdocs\CallyWorld\resources\views/user.blade.php ENDPATH**/ ?>