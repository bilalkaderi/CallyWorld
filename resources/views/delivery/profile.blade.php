         ...
         <div class="col-lg-9 my-lg-0 my-1">
             <div id="main-content" class="bg-white border">
                 <div class="d-flex flex-column">
                     <div class="h5">Hello {{$dman->name}},</div>
                     <div>Logged in as: {{$dman->username}}</div>
                 </div>
                 <div class="d-flex my-4 flex-wrap">
                     <div class="box me-4 my-1 bg-light">
                         <img src="{{asset('css/icons/delivery.png')}}" style="width:55px;height:45px">
                 ...
                 @foreach($orders as $o)
                     <div class="order my-3 bg-light {{$o->delivery_response}}" style="padding:50px" id="order_{{$o->id}}">
                         <div class="row">
                             <div class="col-lg-4">
                               <div class="green-label ms-auto ">Client Name: {{$o->name}}</div>
                                 <div class="justify-content-between order-summary">
                                     <div class="align-items-center">
                                       <div class="text-uppercase">Cart no. #{{$o->id}}</div>
                                     </div>

                                     <div class="fs-8">{{$o->pref_address}}</div>
                               ...
                               <div class="status">Status : {{$o->status}}</div>
                                 <div class="align-items-sm-start justify-content-sm-between">
                                     @if($o->status=='On Delivery')
                                       ...
                                       @endphp
                                       @if($o->delivery_response=='waiting')
                                        @if($timeDiffHours>0)
                                          <div class="red-label ms-auto text-uppercase">{{$timeDiffHours-2}} H and {{$timeDiffMinutes}} min</div>
                                        @else
                                          <div class="red-label ms-auto text-uppercase">Time Passed</div>
                                        @endif
                                        <div class="ms-auto text-uppercase">Del. Time:  {{$o->delivery_hour}}</div>
                                      @endif
                                      @endif
                                 </div>
                                 ...
                                 <div class="progressbar-track">
                                   @if($o->delivery_response=='waiting')
                                     <ul class="progressbar">
                                         ...
                                         <span style="margin-top:20px">{{$o->pref_address}}</span>
                                         <li id="step-5" class="text-muted">
                                             <span class="fas fa-box-open"></span>
                                         </li>
                                     </ul>
                                     <div id="tracker"></div>
                                   @elseif($o->delivery_response=='Delivered')
                                     <ul class="progressbar">
                                       <li id="step-4" class="text-muted green">
                                           <span class="fas fa-truck"></span>
                                       </li>
                                     ...
                                     <div id="tracker"></div>
                                     @elseif($o->delivery_response=='Not Delivered')
                                       <ul class="progressbar">
                                           ...
                                           <div class="col-md-8 col-lg-6 col-xl-4" style="width:450px">
                                               ...
                                               <div class="d-flex justify-content-between">
                                                 <div>
                                                   ...
                                                   @foreach($data as $data)
                                                     ...
                                                     @endphp
                                                     @foreach($prod as $p)
                                                      <p><a href="product/{{$p->id}}" class="text-dark">{{$p->name}} : {{$data['quantity']}} items</a></p>
                                                     @endforeach
                                                   @endforeach
                                             ...
                                             <div class="card-body pb-0">
                                               <div class="d-flex justify-content-between">
                                                 ...
                                                 <p class="text-dark">${{$o->total_amount}}</p>
                                               </div>
                                             ...
                                             <div class="card-body pb-0">
                                               <div class="justify-content-between">
                                                 ...
                                                 <p class="text-dark">Name: {{$o->name}}</p>
                                                 <p class="text-dark">Phone: <a href="tel:{{$o->phone}}">{{$o->phone}}</a></p>
                                               </div>
                                             </div>
                                             <hr class="my-0" />
                                             <div class="card-body">
                                               <div class="d-flex justify-content-between align-items-center pb-2 mb-1">
                                                @if($o->status=='On Delivery')
                                                  <button type="button" onclick="delivered({{$o->id}})" class="btn btn-success">Delivered</button>
                                                  <button type="button" onclick="notdelivered({{$o->id}})" class="btn btn-danger">Not Delivered</button>
                                                @endif
                                               </div>
                                             </div>
                                           </div>
