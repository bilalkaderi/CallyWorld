          ...
          @foreach($cats as $c)
            <tr id="cat_{{$c->id}}">
              ...
              <td>
                ...
                <button type="button" class="btn btn-info" onclick="returnCat({{$c->id}})" data-toggle="modalUser" id="togglemodal" >Edit</button>
                <button type="button" class="btn btn-light" onclick="deleteCat({{$c->id}})">Remove</button>
              </td>
            </tr>
          @endforeach
          <tr>
