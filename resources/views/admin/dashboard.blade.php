                ...
                <div class="card h-100">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      ...
                      <div class="col-auto">
                        <i class=""><img src="{{asset('css/icons/cubes.png')}}" style="width:44px;height:46px"></i>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card h-100">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      ...
                      <div class="col-auto">
                        <i class=""><img src="{{asset('css/icons/sold.png')}}" style="width:44px;height:46px"></i>
                      </div>
                    </div>
                  </div>
                </div>
                            ...
                            <div class="card h-100">
                              <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                  ...
                                  <div class="col-auto">
                                    <i class=""><img src="{{asset('css/icons/comments.png')}}" style="width:44px;height:46px"></i>
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="card h-100">
                              <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                  ...
                                  <div class="col-auto">
                                    <i class=""><img src="{{asset('css/icons/rating.png')}}" style="width:44px;height:46px"></i>
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="card h-100">
                              <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                  ...
                                  <div class="col-auto">
                                    <i class=""><img src="{{asset('css/icons/report.png')}}" style="width:44px;height:46px"></i>
                                  </div>
                                </div>
                              </div>
                            </div>
